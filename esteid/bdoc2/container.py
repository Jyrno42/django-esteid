...
class BDoc2File(object):
    ...
    def add_file(self, file_name, binary_data, mime_type='application/octet-stream'):
        """Add a data file"""
        ...
        self._zip_file.writestr(file_name, binary_data)
        self._manifest_write_required = True
        return self
    ...
    def add_signature(self, signature):
        ...
        self._zip_file.writestr(new_sig_file, signature.dump())
        return self
    ...
    def _add_mimetype(self):
        # NOTE: the mimetype entry should be the first one, as per ETSI TS 102 918 (though optional)
        self._zip_file.writestr(self.MIME_TYPE_FILE, self.MIME_TYPE)
    ...
    def _delete_files(self, *file_names_to_delete):
        ...
        for file_name in self._read_toc():
            ...
            with self.open_file(file_name) as f:
                new_zip_file.writestr(file_name, f.read())
